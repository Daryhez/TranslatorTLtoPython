...
public interface TLONListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TLONParser#leer}.
	 * @param ctx the parse tree
	 */
	void enterLeer(TLONParser.LeerContext ctx);
	/**
	 * Exit a parse tree produced by {@link TLONParser#leer}.
	 * @param ctx the parse tree
	 */
	void exitLeer(TLONParser.LeerContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TLONParser#accesstoobject}.
	 * @param ctx the parse tree
	 */
	void enterAccesstoobject(TLONParser.AccesstoobjectContext ctx);
	/**
	 * Exit a parse tree produced by {@link TLONParser#accesstoobject}.
	 * @param ctx the parse tree
	 */
	void exitAccesstoobject(TLONParser.AccesstoobjectContext ctx);
	/**
	 * Enter a parse tree produced by {@link TLONParser#variableaccessarray}.
	 * @param ctx the parse tree
	 */
	void enterVariableaccessarray(TLONParser.VariableaccessarrayContext ctx);
	/**
	 * Exit a parse tree produced by {@link TLONParser#variableaccessarray}.
	 * @param ctx the parse tree
	 */
	void exitVariableaccessarray(TLONParser.VariableaccessarrayContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code accessObject}
	 * labeled alternative in {@link TLONParser#atom}.
	 * @param ctx the parse tree
	 */
	void enterAccessObject(TLONParser.AccessObjectContext ctx);
	/**
	 * Exit a parse tree produced by the {@code accessObject}
	 * labeled alternative in {@link TLONParser#atom}.
	 * @param ctx the parse tree
	 */
	void exitAccessObject(TLONParser.AccessObjectContext ctx);
	/**
